...
## Reference Files (DO NOT MODIFY - Context Only)

These files provide context about data structures (VO/DTO classes). Use them to understand getter/setter method names and field structures.
**DO NOT include these files in your output. Only modify the files listed in "Source Files to Modify" section above.**
