"""
TypeHandler Code Generator

TypeHandler 레이어를 대상으로 코드 수정을 수행하는 CodeGenerator입니다.
TODO: 구현 예정
"""
...
class TypeHandlerCodeGenerator(BaseCodeGenerator):
    ...
    def generate(self, input_data: CodeGeneratorInput) -> CodeGeneratorOutput:
        ...
        raise NotImplementedError(
            "TypeHandlerCodeGenerator.generate()는 아직 구현되지 않았습니다."
        )
    ...
    def generate_modification_plans(
        ...
        # 현재는 ControllerOrServiceCodeGenerator와 동일한 로직 사용 가능
        raise NotImplementedError(
            "TypeHandlerCodeGenerator.generate_modification_plans()는 아직 구현되지 않았습니다."
        )
