...
class ResultTracker:
    ...
    def __init__(self, output_dir: Optional[Path] = None):
        ...
        """
        self.output_dir = Path(output_dir) if output_dir else Path.cwd() / ".applycrypto" / "results"
    ...
    def save_modification_history(
        ...
        history_data = {
            ...
            "statistics": {
                ...
                "successful_files": sum(1 for m in modifications if m.get("status") == "success"),
                "failed_files": sum(1 for m in modifications if m.get("status") == "failed"),
